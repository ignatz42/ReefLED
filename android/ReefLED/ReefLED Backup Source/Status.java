...
*/
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case R.id.menuPreferences:
			...
			break;
		case R.id.menuDateTime:
			i = new Intent(Status.this, DeviceTime.class);
			break;
		case R.id.menuTemp:
			i = new Intent(Status.this, DeviceTemp.class);
			break;
		case R.id.menuMax:
			i = new Intent(Status.this, DeviceLightMax.class);
			break;
		case R.id.menuSunChanges:
			i = new Intent(Status.this, DeviceSunChanges.class);
			break;
	...
	public void RefreshUIElements()
    {
    	...
    	currentDeviceDateYear    = preferences.getInt("uiCurrentDateYear", 2000);
